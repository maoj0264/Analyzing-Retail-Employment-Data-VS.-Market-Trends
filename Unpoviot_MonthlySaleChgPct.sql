...
;with msChgPct as (
	select 
		...
		,prev.[10] as Prev_10, ((curr.[10] - prev.[10]) / curr.[10]) as [10], curr.[10] as Curr_10
		,prev.[11] as Prev_11, ((curr.[11] - prev.[11]) / curr.[11]) as [11], curr.[11] as Curr_11
		,prev.[12] as Prev_12, ((curr.[12] - prev.[12]) / curr.[12]) as [12], curr.[12] as Curr_12
	from 
...
------- unpivot table
select Rpt_Year, [Data Type], [NAICS  Code], [Kind of Business], 
	u.[Period], u.chg_pct*100 as chg_pct

--into MonthlySalesChanges
from msChgPct s
unpivot
(
  chg_pct for [Period] in ([01], [02],[03], [04],[05],[06],[07],[08],[09],[10],[11],[12])
) u;
